...
const LibraryCard = ({ library }) => {
  ...
  return (
    <div 
      className="group relative bg-slate-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 cursor-pointer transform hover:-translate-y-1"
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {library.distance !== null && library.distance !== undefined && (
          <div className="absolute top-3 right-3 px-3 py-1 bg-blue-500/90 backdrop-blur-sm text-white text-xs font-bold rounded-full flex items-center gap-1">
        ...
        <div className="absolute top-3 left-3 px-3 py-1 bg-slate-900/80 backdrop-blur-sm text-white text-xs font-bold rounded-full">
          {availableSeats > 0 ? (
      ...
      <div className="p-5">
        ...
        {/* Address */}
        <p className="text-sm text-slate-400 mb-3 flex items-start gap-2 line-clamp-2">
        ...
        {/* View Details Button */}
        <button
          className="w-full py-2.5 px-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 flex items-center justify-center gap-2 group-hover:from-purple-700 group-hover:to-pink-700"
          onClick={(e) => {
            e.stopPropagation();
            handleViewDetails();
          }}
